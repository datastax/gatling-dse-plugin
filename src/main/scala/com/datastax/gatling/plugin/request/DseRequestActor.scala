...
case class SendCqlQuery(dseRequestAction: DseCqlRequestAction, session: Session)
case class SendGraphQuery(dseRequestAction: DseGraphRequestAction, session: Session)
