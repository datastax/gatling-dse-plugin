...
class CqlPreparedStatementUtilSpec extends BaseCassandraServerSpec {
  ...
  val defaultSessionVars = Map(
    ...
    "localDate" -> LocalDate.ofEpochDay(1483299340813L),
    ...
    "polygon_type" -> Polygon.fromPoints(Point.fromCoordinates(1.0, 1.0), Point.fromCoordinates(2.0, 2.0),
      Point.fromCoordinates(3.0, 3.0), Point.fromCoordinates(4.0, 4.0))
  )
  ...
  describe("preparedStatements") {
    ...
    describe("getParamsList") {
      ...
      it("should return a list of types") {
        ...
        paramList should contain(DataType.INT)
      }
    ...
    describe("getParamsMap") {
      ...
      it("should return a map of types") {
        ...
        paramsMap("id") shouldBe DataType.INT
      }
  ...
  describe("typeConversion") {
    ...
    describe("asTime") {
      ...
      describe("should accept a String") {
        ...
        it("should accept a String time w/o nanoseconds") {
          val validHour = CqlPreparedStatementUtil.asLocalTime(defaultGatlingSession, "hourTime")
        ...
        it("should not accept invalid seconds and produce a CqlTypeException") {
          ...
          val newSession: Session = gatlingSession.setAll(newSessionVars)
          intercept[CqlTypeException] {
            CqlPreparedStatementUtil.asLocalTime(newSession, "invalidSec") shouldBe a[Long]
          }
        }
        ...
        it("should not accept invalid nanoseconds and produce a CqlTypeException") {
          ...
          val newSession: Session = gatlingSession.setAll(newSessionVars)
          intercept[CqlTypeException] {
            CqlPreparedStatementUtil.asLocalTime(newSession, "invalidNano") shouldBe a[Long]
          }
        }
      ...
      it("should not accept a float and produce a CqlTypeException") {
        intercept[CqlTypeException] {
          CqlPreparedStatementUtil.asLocalTime(defaultGatlingSession, "float") shouldBe a[Long]
        }
      }
    }
    ...
    describe("asTimestamp") {
      ...
      it("should accept an epoch long") {
        CqlPreparedStatementUtil.asInstant(defaultGatlingSession, "epoch") shouldBe a[java.util.Date]
      ...
      it("should accept a java Date") {
        CqlPreparedStatementUtil.asInstant(defaultGatlingSession, "javaDate") shouldBe a[java.util.Date]
        CqlPreparedStatementUtil.asInstant(defaultGatlingSession, "javaDate") shouldBe
            defaultSessionVars("javaDate").asInstanceOf[java.util.Date]
      }

      it("should accept a date string") {
        CqlPreparedStatementUtil.asInstant(defaultGatlingSession, "dateString") shouldBe a[java.util.Date]
      ...
      it("should accept a isoDateString string") {
        CqlPreparedStatementUtil.asInstant(defaultGatlingSession, "isoDateString") shouldBe a[java.util.Date]
      ...
      it("should not accept a float and produce a CqlTypeException") {
        intercept[CqlTypeException] {
          CqlPreparedStatementUtil.asInstant(defaultGatlingSession, "float") shouldBe a[java.util.Date]
        }
      }
    ...
    describe("asTuple") {
      ...
      val tupleType = dseSession.getMetadata.newTupleType(DataType.VARCHAR, DataType.VARCHAR)
  ...
  describe("boundStatementFunctions") {
    ...
    describe("bindParamByOrder") {
      ...
      it("should bind with a UUID") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.UUID, "uuid", 0)
        result shouldBe a[BoundStatement]
        result.isSet(0) shouldBe true
      }

      it("should bind with a timeUuid") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.TIMEUUID, "timeUuid", 1)
        result shouldBe a[BoundStatement]
        result.isSet(1) shouldBe true
      }

      it("should bind with a int") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.INT, "int", 2)
        result shouldBe a[BoundStatement]
        result.isSet(2) shouldBe true
      }

      it("should bind with a text") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.VARCHAR, "string", 3)
        result shouldBe a[BoundStatement]
        result.isSet(3) shouldBe true
      }

      it("should bind with a varchar") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.VARCHAR, "string", 4)
        result shouldBe a[BoundStatement]
        result.isSet(4) shouldBe true
      }

      it("should bind with a ascii") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.ASCII, "string", 5)
        result shouldBe a[BoundStatement]
        result.isSet(5) shouldBe true
      }

      it("should bind with a float") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.FLOAT, "float", 6)
        result shouldBe a[BoundStatement]
        result.isSet(6) shouldBe true
      }

      it("should bind with a double") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.DOUBLE, "double", 7)
        result shouldBe a[BoundStatement]
        result.isSet(7) shouldBe true
      }

      it("should bind with a decimal") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.DECIMAL, "double", 8)
        result shouldBe a[BoundStatement]
        result.isSet(8) shouldBe true
      }

      it("should bind with a boolean") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.BOOLEAN, "boolean", 9)
        result shouldBe a[BoundStatement]
        result.isSet(9) shouldBe true
      }

      it("should bind with a inetAddress") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.INET, "inetStr", 10)
        result shouldBe a[BoundStatement]
        result.isSet(10) shouldBe true
      }

      it("should bind with a timestamp") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.TIMESTAMP, "epoch", 11)
        result shouldBe a[BoundStatement]
        result.isSet(11) shouldBe true
      }

      it("should bind with a bigInt") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.BIGINT, "bigInteger", 12)
        result shouldBe a[BoundStatement]
        result.isSet(12) shouldBe true
      }

      it("should bind with a blob_type") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.BLOB, "byteArray", 13)
        result shouldBe a[BoundStatement]
        result.isSet(13) shouldBe true
      }

      it("should bind with a varint") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.VARINT, "int", 14)
        result shouldBe a[BoundStatement]
        result.isSet(14) shouldBe true
      }

      it("should bind with a list") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.LIST, "list", 15)
        result shouldBe a[BoundStatement]
        result.isSet(15) shouldBe true
      }

      it("should bind with a set") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.SET, "set", 16)
        result shouldBe a[BoundStatement]
        result.isSet(16) shouldBe true
      }

      it("should bind with a map") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.MAP, "map", 17)
        result shouldBe a[BoundStatement]
        result.isSet(17) shouldBe true
      }

      it("should bind with a date") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.DATE, "epoch", 18)
        result shouldBe a[BoundStatement]
        result.isSet(18) shouldBe true
      }

      it("should bind with a smallInt") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.SMALLINT, "int", 19)
        result shouldBe a[BoundStatement]
        result.isSet(19) shouldBe true
      }

      it("should bind with a tinyint") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.TINYINT, "int", 20)
        result shouldBe a[BoundStatement]
        result.isSet(20) shouldBe true
      }

      it("should bind with a time") {
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.TIME, "epoch", 21)
        result shouldBe a[BoundStatement]
      ...
      it("should bind with a tuple") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByOrder(tupleSession, boundStatementKeys, DataType.TUPLE, "tuple_type", 22)
        result shouldBe a[BoundStatement]
      ...
      it("should bind with a udt") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByOrder(udtSession, boundStatementKeys, DataType.UDT, "fullname2", 23)
        result shouldBe a[BoundStatement]
      ...
      it("should bind with a counter") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementCounter, DataType.COUNTER, "int", 0)
        result shouldBe a[BoundStatement]
        result.isSet(0) shouldBe true
      }
      ...
      it("should bind with a null") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.TINYINT, "null_type", 24)
        result shouldBe a[BoundStatement]
      ...
      it("should not set and unset a None value") {
        ...
        CqlPreparedStatementUtil.bindParamByOrder(defaultGatlingSession, boundStatementKeys, DataType.VARCHAR, field, 25) shouldBe a[BoundStatement]
        boundStatementKeys.isSet(field) shouldBe false

        val newSessionVars = Map(field -> "test")
        val newSession: Session = gatlingSession.setAll(newSessionVars)

        CqlPreparedStatementUtil.bindParamByOrder(newSession, boundStatementKeys, DataType.VARCHAR, field, 25) shouldBe a[BoundStatement]
    ...
    describe("bindParamByName") {
      ...
      it("should bind with a UUID") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.UUID, paramName)
        result shouldBe a[BoundStatement]
      ...
      it("should bind with a timeUuid") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.TIMEUUID, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a int") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.INT, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a text") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.VARCHAR, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a ascii") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.ASCII, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a float") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.FLOAT, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a double") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.DOUBLE, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a decimal") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.DECIMAL, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a boolean") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.BOOLEAN, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a inetAddress") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.INET, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a timestamp") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.TIMESTAMP, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      ...
      it("should bind with a bigInt") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.BIGINT, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a blob_type") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.BLOB, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a varint") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.VARINT, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a list") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.LIST, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a set") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.SET, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a map") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.MAP, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a date") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.DATE, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a smallInt") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.SMALLINT, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a tinyint") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.TINYINT, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a time") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.TIME, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a tuple") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(tupleSession, boundStatementNames, DataType.TUPLE, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a udt") {
        ...
        val addressType = dseSession.getMetadata.getKeyspace(keyspace).get.getUserDefinedType("fullname2")
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(udtSession, boundStatementNames, DataType.UDT, paramName)
        result shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
      }
      ...
      it("should bind with a counter") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(typeSession, boundNamedStatementCounter, DataType.COUNTER, paramName)
        result shouldBe a[BoundStatement]
      }
      ...
      it("should not set and unset a None value") {
        ...
        val result2 = CqlPreparedStatementUtil.bindParamByName(newSession, boundStatementNames, DataType.VARCHAR, paramName)
        result2 shouldBe a[BoundStatement]
        boundStatementNames.isSet(paramName) shouldBe true
        boundStatementNames.getString(paramName) shouldBe "test"

        val result3 = CqlPreparedStatementUtil.bindParamByName(typeSession, boundStatementNames, DataType.VARCHAR, paramName)
      ...
      it("should not set a missing session value") {
        ...
        val result = CqlPreparedStatementUtil.bindParamByName(newSession, boundStatementNames, DataType.VARCHAR, field)
        result shouldBe a[BoundStatement]
