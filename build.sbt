...
libraryDependencies += "com.datastax.dse"             %  "dse-java-driver-core"     % "1.6.7-aaaceb47a-java1712-SNAPSHOT"
libraryDependencies += "com.datastax.dse"             %  "dse-java-driver-graph"    % "1.6.7-aaaceb47a-java1712-SNAPSHOT"
